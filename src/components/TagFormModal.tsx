...
export default function TagFormModal() {
    ...
    const handleSave = async () => {
        ...
        try {
            const finalColor = customColorMode && customHexCode ? customHexCode : selectedColor;
            if (tag) {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    {/* Selector de Color */}
                    <Text style={[styles.sectionTitle, { marginTop: 20 }]}>Color de etiqueta</Text>
                    <View style={styles.colorRow}>
                        ...
                        <TouchableOpacity
                            style={[styles.colorOption, { backgroundColor: '#333' }, customColorMode && styles.colorOptionSelected]}
                    ...
                    {customColorMode && (
                        <View style={styles.colorPickerOverlay}>
                            ...
                            <View style={styles.pickerHeader}>
                                <View style={[styles.pickerPreviewDot, { backgroundColor: customHexCode || '#FFFFFF' }]} />
                                <Text style={styles.pickerHexLabel}>
                                    {customHexCode ? customHexCode.toUpperCase() : 'Elige un color'}
                                </Text>
                            </View>
