...
export const useSettingsStore = create<SettingsState>()(
    persist(
        (set) => ({
            ...
            setShowPlayerVisualizer: (value) => set((state) => ({
                showPlayerVisualizer: value,
                showCanvas: value ? false : state.showCanvas,
            })),
            ...
            setPlayerCoverStyle: (value) => set((state) => ({
                playerCoverStyle: value,
                showCanvas: (value === 'cd' || value === 'vinyl') ? false : state.showCanvas,
            })),
            playerBackgroundStyle: 'cover',
            setPlayerBackgroundStyle: (value) => set({ playerBackgroundStyle: value }),
            showCanvas: true,
            setShowCanvas: (value) => set((state) => ({
                showCanvas: value,
                showPlayerVisualizer: value ? false : state.showPlayerVisualizer,
                playerCoverStyle: value ? 'cover' : state.playerCoverStyle,
            })),
